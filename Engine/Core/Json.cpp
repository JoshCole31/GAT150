...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, Vector2& data)
{
...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, Color& data)
{
	// check if 'name' member exists and is an array with 2 elements
...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, SDL_Rect& data)
{
	// check if 'name' member exists and is an array with 2 elements
